...
/**
 * Abstraction of Interface Adapter The following parameters are set by using
 * the configuration file
 *
 * id :is the Interface ID (The same ID for another interface cannot be exist)
 * ipv4 :is the IPv4 Address assigned to the interface channel_idx : is the
 * reference ID for the related channel
 *
 * @author afsantamaria
 */
