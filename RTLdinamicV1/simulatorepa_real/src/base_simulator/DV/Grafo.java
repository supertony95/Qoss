...
/**
 * Questa classe è una rappresentazione astratta della rete: Il grafo deve
 * essere istanziato su ogni nodo (preferibilmente a livello network) Sarà
 * utilizzato dai protocolli e algoritmi di routing per effettuare le dovute
 * operazioni
 *
 * @author afsantamaria
 */
public class Grafo {
    ...
    //il parametro n indica di quanti nodi e' composto il grafo
    protected int n;
     ...
     * @return
     */
    public ArrayList<Integer> getNodesExceptSource(int myId) {
