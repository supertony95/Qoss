...
public class Messaggi implements Cloneable {
    ...
    public int numberHop=0;
    private String tipo_Messaggio;
    private Object data;
    private double packet_size;
    public int receiveWin;
    private boolean ackValue=false;

    /**
     * Get della dimensione della finestra disponibile sul ricevitore per
     * garantire ordine dei pacchetti
     *
    ...
    /**
     * Setta il parametro per reperire informazioni sulla disponibilità del
     * ricevitore a ricevere un determinato numero di MSS la finestra viene
     * riportata in Byte
     *
     * @param receiveWin
     */
    ...
    /**
     * *****************
     * AGGIUNTO 01/02/2007 aggiungo questo campo nel msg che mi serve per la
     * propagazione dei msg di BID, per limintare la Local Search previsto nel
     * protocollo QoSMIC *****************
     */
    ...
    /**
     * indica se il messaggio deve salire nella pila o scendere se true il
     * messaggio è ricevuto e e quindi salire nella pila
     */
    ...
    /**
     * Quando il messaggio vine creato deve essere indicato anche il nodo
     * destinazione e non solo l'oggetto della pila protocollare
     */
    ...
    /**
     * @brief : Questo metodo mi permette di aggiumgere una lista di spot ai
     * quali passare i messaggi il campo spots può essere utilizzato sia per il
     * broadcast che per altri tipi di paradigmi di funzionamento
     * @param spot
     */
    ...
    /**
     * Il metodo permette di ottenere l'informazione dati contenuta nel
     * messaggio
     *
     * @return
     */
