...
public class main_app extends javax.swing.JFrame {
    ...
    public static  int NumeroMappa=1;

    private static void init_sim_parameters() {
        s = new scheduler(4000000, false);
    }
...
//        jTextField1.setText("conf.xml");
        jTextField1.setText("src/Vanet/conf.xml");
...
//In response to a button click:
    ...
    private boolean startParsing(File xmlFile) {
        roadMap = new MobilityMap(NumeroMappa);
...
//                tcpTransportLayer tl = new tcpTransportLayer(s, 5.0);
 ...
 //               nodo_host nh = new nodo_host(s, id, pl, ll, nl,tl, null, "nodo_host", gateway);
                ...
                if(nodo_ingresso.equals(nodo_uscita)){
                	String idSem = ((Element) nodo).getAttributeValue("id");
                	NodoSemaforo ns = new NodoSemaforo(s, id, pl, ll, nl, tl, null, "nodo_host", gateway);
                	ns.setMappa(roadMap);
                	ns.setExitFromGate(exitGateAt);
                	ns.setNodo_ingresso(nodo_ingresso);
                	ns.setNodo_uscita(nodo_uscita);
                	sem_node sem= new sem_node(id,nodo_ingresso);
                	roadMap.semaphore.put(nodo_ingresso, sem);
                ...
                car_node car = new car_node(id, 0, 0,nodo_ingresso);
...
//                List listElement1 = node.getChildren("canale");
            ...
            for (Object nodo : listElement) {
                ...
                for (vehicleCounter = 0; vehicleCounter < maxVehicles; vehicleCounter++) {
                    ...
                    nh.setNodo_uscita(nodo_uscita);
                    nh.setExitFromGate(exitGateAt);
                    car_node car = new car_node(id, 0, 0,nodo_uscita);
                    roadMap.vehicles.put("" + id, car);
